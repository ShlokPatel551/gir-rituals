...
import { ADMIN_NOTIFS, type AdminNotif } from '../data/adminNotifications';
...
export function AdminLayout() {
  ...
  const notifs: AdminNotif[] = ADMIN_NOTIFS.map((n) => ({ ...n, read: readIds.has(n.id) }));
  ...
  function handleNotifClick(link: string, id: string) {
