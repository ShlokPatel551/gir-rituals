...
function Notifications() {
  ...
  return <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
        ...
        {unread > 0 && <button type="button" className="btn btn-ghost" style={{ fontSize: "0.85rem" }} onClick={markAllNotificationsRead}>
            Mark all read
          </button>}
      </div>
      {notifications.map((n) => <Link
    key={n.id}
    to={n.link || "#"}
    className="card"
    style={{ display: "block", marginBottom: "0.75rem", opacity: n.read ? 0.85 : 1, borderLeft: n.read ? void 0 : "4px solid var(--green-600)" }}
  >
