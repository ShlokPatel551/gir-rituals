...
function AdminOtp() {
  ...
  return <div>
      ...
      {activeOtps.length > 0 && <div className="admin-table-wrap" style={{ marginBottom: "2rem" }}>
      ...
      {logs.length === 0 ? <p className="card">No OTP events yet.</p> : <div className="admin-table-wrap">
          <table className="admin-table">
            <thead>
              <tr>
                <th>Time</th>
