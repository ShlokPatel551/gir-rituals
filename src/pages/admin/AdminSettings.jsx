...
async function computeTOTP(secret, window = 0) {
  const counter = Math.floor(Date.now() / 3e4) + window;
...
function AdminSettings() {
  ...
  const otpauthUri = totpSecret ? `otpauth://totp/GirRituals:${admin?.email ?? "owner@girrituals.com"}?secret=${totpSecret}&issuer=GirRituals&algorithm=SHA1&digits=6&period=30` : "";
  ...
  >
              {t.label}
              {t.key === "twofa" && <span className={`as-tab-pill ${twoFaEnabled ? "as-tab-pill-on" : "as-tab-pill-off"}`}>
                  {twoFaEnabled ? "ON" : "OFF"}
                </span>}
            </button>)}
        </nav>
    ...
    /* ── Accounts tab ── */
          ...
          {activeTab === "accounts" && <div className="as-accounts-content">
              ...
              <div className="admin-table-wrap as-admins-table">
                <table className="admin-table">
                  ...
                  <tbody>
                    {ADMINS.map((a) => <tr key={a.email} className="as-admin-row">
                        <td>
  ...
  >
    ...
    /* ── 2FA Security tab ── */
          ...
          {activeTab === "twofa" && <div className="as-twofa-content">
    ...
    /* Status banner */
              ...
              <div className={`as-twofa-status ${twoFaEnabled ? "as-twofa-status-on" : "as-twofa-status-off"}`}>
                ...
                {twoFaEnabled ? <button type="button" className="as-twofa-disable-btn" onClick={handleDisable2FA}>
                    Disable 2FA
                  </button> : twoFaStep === "idle" && <button type="button" className="as-btn-filled" onClick={handleStart2FA}>
    ...
    /* Setup flow card */
              ...
              {!twoFaEnabled && twoFaStep !== "idle" && <div className="as-twofa-setup-card">
  ...
  />
                        {otpError && <p className="as-twofa-error">
  ...
  >
    ...
    /* Step 3 — Success */
                  ...
                  {twoFaStep === "done" && <div className="as-twofa-success">
  ...
  >
    ...
    /* ── Other tabs placeholder ── */
          ...
          {activeTab !== "accounts" && activeTab !== "twofa" && <div className="as-placeholder">
