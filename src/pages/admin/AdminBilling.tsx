...
type BilTab    = 'subscriptions' | 'orders';
type SubStatus = 'paid' | 'overdue' | 'pending';
type OrdStatus = 'success' | 'failed' | 'processing';
...
const SUB_STATUS_CSS: Record<SubStatus, string> = {
  paid:    'bil-badge-paid',
...
const ORD_STATUS_CSS: Record<OrdStatus, string> = {
  success:    'bil-badge-success',
  failed:     'bil-badge-failed',
  processing: 'bil-badge-processing',
};
const ORD_STATUS_LABEL: Record<OrdStatus, string> = {
  success:    'SUCCESS',
  failed:     'FAILED',
...
export function AdminBilling() {
  ...
  const [activeTab,    setActiveTab]    = useState<BilTab>('subscriptions');
    ...
    <div className="bil-page">
                    ...
                    <tr key={row.id}>
                      ...
                      <td>
                        <div className="bil-row-actions">
                          <button type="button" className="bil-icon-btn" title="Generate Bill"
                          ...
                          <button type="button" className="bil-icon-btn" title="Send Invoice"
                            onClick={() => showToast(`Invoice sent to ${row.name}`)}>
                            <span className="material-symbols-outlined" style={{ fontSize: 20 }}>send</span>
                          </button>
                          <button type="button" className="bil-icon-btn bil-icon-btn-warn" title="Pause Billing"
      ...
      <div className="bil-insights-grid">
        ...
        <div className="bil-insights-dark">
          ...
          <div className="bil-insights-body-wrap">
            ...
            <div className="bil-insights-btns">
              <button type="button" className="bil-insights-btn-light"
                onClick={() => navigate('/admin/analytics')}>
                View Projection Report
              </button>
              <button type="button" className="bil-insights-btn-ghost"
        ...
        <div className="bento-card bil-refund-card">
          ...
          <button type="button" className="bil-refund-btn"
