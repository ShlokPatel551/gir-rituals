...
type TxnType   = 'subscription' | 'sale' | 'refund';
type TxnStatus = 'completed' | 'pending';
type TxnTab    = 'all' | 'sales' | 'refunds';
...
const TYPE_TAB_MAP: Record<TxnTab, TxnType[]> = {
...
export function AdminFinance() {
  ...
  const visible = TRANSACTIONS.filter((t) =>
    TYPE_TAB_MAP[tab].includes(t.type),
  );
            ...
            <div className="fin-txn-header">
              ...
              <div className="fin-txn-controls">
                <div className="fin-tab-group">
                  {(['all', 'sales', 'refunds'] as TxnTab[]).map((t) => (
                    <button
                      key={t}
                      type="button"
        ...
        <div className="fin-right-col">
          ...
          <div className="bento-card fin-tools-card">
            ...
            <div className="fin-tools-list">
              {TOOLS.map((tool) => (
                <button key={tool.icon} type="button" className="fin-tool-btn" onClick={() => tool.path && navigate(tool.path)}>
