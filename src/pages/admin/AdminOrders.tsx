...
const ORDERS: AdminOrder[] = [
  ...
  { id: '#ORD-92855', customer: 'Meera Patel',   initials: 'MP', email: 'meera.p@icloud.com',  avatarBg: '#ffca98', avatarColor: '#7a532a', product: 'Desi Cow Paneer 500g (×2)',          amount: '₹840',   date: 'May 25, 2026', status: 'shipped'    },
  ...
  { id: '#ORD-92872', customer: 'Sanjay Kapoor', initials: 'SK', email: 's.kapoor@hot.com',    avatarBg: '#a5d0b9', avatarColor: '#274e3d', product: 'Organic Curd 1kg (×3)',              amount: '₹540',   date: 'May 26, 2026', status: 'processing' },
      ...
      <div className="bento-card ord-table-card">
        ...
        <div className="admin-table-wrap" style={{ border: 'none', borderRadius: 0 }}>
          <table className="admin-table ord-table">
            ...
            <tbody>
              {visible.map((row) => (
                <tr key={row.id} className="ord-row">
        ...
        <div className="ord-pagination">
          ...
          <div className="ord-page-nums">
            {[1, 2, 3].map((n) => (
              <button key={n} type="button" className={`ord-page-num ${n === 1 ? 'ord-page-active' : ''}`}>{n}</button>
            ))}
