...
type CustomerStatus = 'active' | 'paused' | 'new';
...
const MOCK_CUSTOMERS: DisplayCustomer[] = [
...
function storedToDisplay(c: StoredCustomer, i: number): DisplayCustomer {
...
export function AdminCustomers() {
  ...
  const allCustomers: DisplayCustomer[] = useMemo(() => {
    ...
    <div className="cust-page">
      ...
      <div className="cust-toolbar">
        ...
        <div className="cust-filter-tabs">
          {(['all', 'active', 'paused', 'new'] as const).map((tab) => (
            <button
              key={tab}
              type="button"
            ...
            >
              {tab === 'all' ? 'All' : STATUS_LABEL[tab as CustomerStatus]}
