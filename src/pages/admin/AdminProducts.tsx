...
type StockLevel = 'full' | 'reorder' | 'low' | 'out';
...
const STOCK_LEVEL_TO_FILTER: Record<StockLevel, string> = {
  full: 'Full Stock',
      ...
      <div className="bento-card inv-table-card">
              ...
              {filtered.map((p) => (
                ...
                >
                  ...
                  <td style={{ textAlign: 'center' }}>
                    {p.status === 'active' ? (
                      <span className="inv-badge inv-badge-active">
                        <span className="inv-dot inv-dot-green" />
                        Active
                      </span>
                    ) : (
                      <span className="inv-badge inv-badge-hidden">
                  ...
                  <td style={{ textAlign: 'right' }}>
                    <div className="inv-action-row">
                      <button
                        ...
                        title="Edit"
                        onClick={(e) => { e.stopPropagation(); showToast(`Editing ${p.name}…`); }}
                      >
        ...
        <div className="inv-pagination">
          ...
          <div className="inv-page-nums">
            ...
            {[1, 2, 3].map((n) => (
              <button key={n} type="button" className={`inv-page-num ${n === 1 ? 'inv-page-active' : ''}`}>{n}</button>
            ))}
