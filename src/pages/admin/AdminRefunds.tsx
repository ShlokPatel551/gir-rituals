...
const INITIAL_REQUESTS: RefundRequest[] = [
  {
    id: 'r1',
    name: 'Priya Shah', initials: 'PS', email: 'priya.s@email.com',
    orderId: 'ORD-089',
    reason: 'Delivery not received', reasonSub: 'Scheduled for May 12',
    amount: '₹140',
    avatarBg: 'var(--admin-primary-fixed)',
  },
  {
    id: 'r2',
    name: 'Rahul M.', initials: 'RM', email: 'rahul_45@provider.in',
    orderId: 'ORD-045',
    reason: 'Wrong quantity', reasonSub: 'Received 2kg instead of 5kg',
    amount: '₹70',
    avatarBg: '#ffdcc4',
  },
  {
    id: 'r3',
    name: 'Meena Patel', initials: 'MP', email: 'meena.p@gmail.com',
    orderId: 'ORD-031',
    reason: 'Quality issue', reasonSub: 'Milk soured before expiry',
    amount: '₹210',
...
const BAR_DATA = [
  { h: 40, tip: '₹450' }, { h: 65, tip: null }, { h: 30, tip: null },
  { h: 85, tip: '₹920', highlight: true }, { h: 55, tip: null }, { h: 45, tip: null },
  { h: 25, tip: null }, { h: 60, tip: null }, { h: 75, tip: null },
  { h: 50, tip: null }, { h: 95, tip: '₹1,140', highlight: true }, { h: 40, tip: null },
];
...
export function AdminRefunds() {
  ...
  const [removingIds, setRemoving]    = useState<Set<string>>(new Set());

  function dismiss(id: string, approve: boolean) {
      ...
      <div className="rf-analytics-grid">
        ...
        <div className="bento-card rf-chart-card">
          ...
          <div className="rf-bar-chart">
            {BAR_DATA.map((b, i) => (
              <div key={i} className={`rf-bar-wrap ${b.highlight ? 'rf-bar-highlight' : ''}`}>
