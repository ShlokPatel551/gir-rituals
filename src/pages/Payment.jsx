...
function Payment() {
  ...
  return <div style={{ maxWidth: 480, margin: "0 auto", padding: "2rem 1rem", minHeight: "100vh" }}>
      ...
      <div className="card" style={{ marginBottom: "1rem" }}>
        ...
        {walletApplied > 0 && <div style={{ display: "flex", justifyContent: "space-between", padding: "0.4rem 0", borderBottom: "1px solid var(--border)", color: "var(--green-700)", fontSize: "0.9rem" }}>
      ...
      {walletBalance > 0 && <div className="card" style={{ marginBottom: "1rem" }}>
      ...
      <div className="card" style={{ marginBottom: "1rem" }}>
        ...
        {paymentMethods.map((pm) => <label key={pm.id} style={{ display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.5rem 0", cursor: "pointer" }}>
        ...
        {method === "upi-manual" && <input value={upiId} onChange={(e) => setUpiId(e.target.value)} placeholder="yourname@upi" style={{ marginTop: "0.5rem" }} />}
        <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.5rem 0", cursor: "pointer" }}>
...
function PaymentFailure() {
  const [searchParams] = useSearchParams();
  const amount = searchParams.get("amount");
  return <div className="payment-failure">
